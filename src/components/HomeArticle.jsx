...
const HomeArticle = () => {
  return (
    <div className="article-section flex justify-center items-start self-stretch">
      <div className="article-container flex w-96 flex-col items-start gap-4 py-12 border-b-[1px] border-neutral-3">
        ...
        <div className="articles flex items-center justify-center gap-6 self-stretch">
          <div className="article-card flex w-96 flex-col items-start justify-center gap-3">
            <img src={ArticleImage} className="w-96" alt="" />
