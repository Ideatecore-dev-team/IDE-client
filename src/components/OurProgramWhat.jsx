      ...
      <div className="what-we-do-container flex lg:w-[1224px] w-full xs:px-6 py-12 flex-col items-start">
        <div className="title flex lg:w-[520px] flex-col items-start gap-4 xs:self-stretch">
          ...
          <div className="dropdown relative w-full">
            ...
            >
              <option value="1">Democracy Affairs</option>
              <option value="2">Education Affairs</option>
              <option value="3">Social Affairs</option>
              <option value="4">Entrepreneurship Affairs</option>
              <option value="5">Interfaith Affairs</option>
            </select>
            <MdArrowDropDown
